...
<section class="message-sec">
  <div class="message-sec__inner">
    ...
    <p class="message-sec__text">はじめたきっかけは所謂副業ブームにのったことがきっかけです。HTML/CSSを勉強したてはめちゃめちゃわくわくしていたのを覚えています。その後、勉強がものすごく楽しかったので、本職にしようと決意し、サーバーサイド言語に力を入れて勉強しておりました。ポートフォリオもでき、転職活動を開始したのですが、これが撃沈でした。まず相手にしてもらってなかったです。500社以上はエントリーしたのですが、全く決まる気配がありません。しかし、その中でも真摯に対応してくださり、アドバイスまでいただける企業様がWeb制作会社様が多かったのです。また成果物できたら見せてくださいって言っていただける企業様が何件かありました。そのアドバイスを実践し、デザインにも挑戦したり、サイトを作成するなど、Web制作の勉強に完全にシフトしました。そこで、勉強して気づきました。Webサイトは誰かの経済を活性化させたり、豊かにする力があると。コロナの影響により、世の中の元気がない気がします。自分も転職活動で苦しい思いをしています。経済が活性化されたほうが、絶対楽しいんです。だから、僕はWeb制作の力でたくさんの方を豊かにするお役に立ちたい。そして世の中を少しでも明るくする力になりたいです。</p>
  </div>
</section>
